...
Модифікувати проєкт, для цього необхідно:
...
*всього має бути продемонстровано роботу мінімум з трьома делегатами, один із яких є власним.
...
Вміст консольного додатку (**__Cinema.cs__**):
...
Вміст консольного додатку (**__Session.cs__**):
...
Вміст консольного додатку (**__Hall.cs__**):
...
Вміст консольного додатку (**__Customer.cs__**):
...
Вміст консольного додатку (**__Movie.cs__**):
...
Вміст консольного додатку (**__FilmType.cs__**):
...
Вміст консольного додатку (**__TicketGroup.cs__**):
...
Вміст консольного додатку (**__TicketSingle.cs__**):
...
Вміст консольного додатку (**__Ticket.cs__**):
...
Вміст консольного додатку (**__UnitTest.cs__**):
